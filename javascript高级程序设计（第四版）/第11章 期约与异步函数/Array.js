...
;(function (global, utils, extrasUtils) {
  ...
  function UseSparseVariant(array, length, is_array, touched) {
    ...
    return (
      estimated_elements < elements_threshold &&
  ...
  function ArrayPop() {
    ...
    if (%IsObserved(array)) return ObservedArrayPop.call(array, n)
  ...
  function ArrayPush() {
    ...
    if (%IsObserved(this)) return ObservedArrayPush.apply(this, arguments)
  ...
  function ArrayShift() {
    ...
    if (%IsObserved(array)) return ObservedArrayShift.call(array, len)
  ...
  function ArrayUnshift(arg1) {
    // length == 1
    CHECK_OBJECT_COERCIBLE(this, 'Array.prototype.unshift')

    if (%IsObserved(this)) return ObservedArrayUnshift.apply(this, arguments)
    ...
    if (
      len > 0 &&
      UseSparseVariant(array, len, IS_ARRAY(array), len) &&
  ...
  function ComputeSpliceDeleteCount(delete_count, num_arguments, len, start_i) {
    ...
    // compatibility.
    var del_count = 0
    if (num_arguments == 1) return len - start_i

    del_count = TO_INTEGER(delete_count)
    if (del_count < 0) return 0

    if (del_count > len - start_i) return len - start_i
  ...
  function ArraySplice(start, delete_count) {
    ...
    if (%IsObserved(this)) return ObservedArraySplice.apply(this, arguments)
  ...
  function InnerArraySort(array, length, comparefn) {
    ...
    var CopyFromPrototype = function CopyFromPrototype(obj, length) {
      var max = 0
      for (
        var proto = %_GetPrototype(obj);
        proto;
        proto = %_GetPrototype(proto)
      ) {
  ...
  function InnerArrayLastIndexOf(
    array,
    element,
    index,
    length,
  ...
  function InnerArrayReduceRight(
    callback,
    current,
    array,
    length,
  ...
  utils.InstallFunctions(GlobalArray.prototype, DONT_ENUM, [
    'toString',
    getFunction('toString', ArrayToString),
    'toLocaleString',
    getFunction('toLocaleString', ArrayToLocaleString),
    'join',
    getFunction('join', ArrayJoin),
    'pop',
    getFunction('pop', ArrayPop),
    'push',
    getFunction('push', ArrayPush, 1),
    'reverse',
    getFunction('reverse', ArrayReverse),
    'shift',
    getFunction('shift', ArrayShift),
    'unshift',
    getFunction('unshift', ArrayUnshift, 1),
    'slice',
    getFunction('slice', ArraySlice, 2),
    'splice',
    getFunction('splice', ArraySplice, 2),
    'sort',
    getFunction('sort', ArraySort),
    'filter',
    getFunction('filter', ArrayFilter, 1),
    'forEach',
    getFunction('forEach', ArrayForEach, 1),
    'some',
    getFunction('some', ArraySome, 1),
    'every',
    getFunction('every', ArrayEvery, 1),
    'map',
    getFunction('map', ArrayMap, 1),
    'indexOf',
    getFunction('indexOf', ArrayIndexOf, 1),
    'lastIndexOf',
    getFunction('lastIndexOf', ArrayLastIndexOf, 1),
    'reduce',
    getFunction('reduce', ArrayReduce, 1),
    'reduceRight',
    getFunction('reduceRight', ArrayReduceRight, 1),
    'copyWithin',
    getFunction('copyWithin', ArrayCopyWithin, 2),
    'find',
    getFunction('find', ArrayFind, 1),
    'findIndex',
    getFunction('findIndex', ArrayFindIndex, 1),
    'fill',
    getFunction('fill', ArrayFill, 1),
    'includes',
    getFunction('includes', ArrayIncludes, 1),
  ])
  ...
  utils.SetUpLockedPrototype(InternalArray, GlobalArray(), [
    'indexOf',
    getFunction('indexOf', ArrayIndexOf),
    'join',
    getFunction('join', ArrayJoin),
    'pop',
    getFunction('pop', ArrayPop),
    'push',
    getFunction('push', ArrayPush),
    'shift',
    getFunction('shift', ArrayShift),
    'sort',
    getFunction('sort', ArraySort),
    'splice',
    getFunction('splice', ArraySplice),
  ])
  ...
  utils.SetUpLockedPrototype(extrasUtils.InternalPackedArray, GlobalArray(), [
    ...
    getFunction('shift', ArrayShift),
    'unshift',
    getFunction('unshift', ArrayUnshift),
    'splice',
    getFunction('splice', ArraySplice),
    'slice',
    getFunction('slice', ArraySlice),
  ])
